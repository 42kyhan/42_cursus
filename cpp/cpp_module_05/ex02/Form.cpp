...
const char *Form::OpenFileFail::what(void) const throw()
{
...
std::string const &Form::getType() const
{
	return (this->type_);
}

void	Form::setType(std::string const &type)
{
...
void	Form::executable(Bureaucrat const &obj) const
{
	...
	if (obj.getGrade() > this->execGrade_)
		throw GradeTooHighException();
}
